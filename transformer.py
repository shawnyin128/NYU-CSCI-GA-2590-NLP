...
class TransformerLayer(nn.Module):
    ...
    def forward(self, input_vecs):
        ...
        attn_score = q_state @ k_state.transpose(-2, -1) # [N, N]
        attn_weight = nn.functional.softmax(attn_score / math.sqrt(self.d_internal), dim=-1) # [N, N]
        attn_output = attn_weight @ v_state # [N, d_internal]
